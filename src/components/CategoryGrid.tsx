      ...
      <div className="max-w-[1280px] mx-auto px-gutter">
        ...
        <div className="flex justify-between items-end mb-stack-lg flex-wrap gap-4">
          <div className="space-y-stack-sm">
            ...
            <h2 className="text-h2 font-bold text-on-surface">Öne Çıkan Ürün Grupları</h2>
          </div>
          ...
          <div className="bg-white p-4 border border-outline-variant flex items-center gap-3">
            <div className="w-10 h-10 bg-primary-container flex items-center justify-center">
              <span className="text-on-primary font-bold text-xs">TR</span>
            </div>
          ...
          {categories.map((cat) => (
            ...
            >
              ...
              <div className="p-stack-md flex flex-col flex-grow">
                <h3 className="text-h3 font-semibold text-on-surface group-hover:text-primary-container transition-colors">
                  {cat.title}
                </h3>
                <p className="text-secondary-container text-body-md mt-2 flex-grow">
